...
exports.book_create_post = [
  ...
  body("genre.*").escape(), //We use a wildcard (*) in the sanitizer to individually validate each of the genre array entries. 
  ...
  asyncHandler(async (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      // In order to mark the genres that were checked by the user we iterate through all the genres and add the 
...
exports.book_delete_get = asyncHandler(async (req, res, next) => {
  ...
  // Get details of books and all their instances
